...
describe("Movie Controller Unit Tests", () => {
  ...
  describe("createMovie", () => {
    ...
    it("should create movie successfully", async () => {
      ...
      (directorService.getDirectorById as jest.Mock).mockResolvedValue({
        _id: "director-id",
      });
      ...
      const promise = movieController.createMovie(
        mockRequest,
        mockResponse as ServerResponse,
      );
    ...
    it("should validate imdbId format", async () => {
      ...
      expect(responseData.success).toBe(false);
      expect(responseData.error).toContain(
        "Invalid IMDb ID format. Use ttXXXXXXXX",
      );
    });
  ...
  describe("updateMovie", () => {
    ...
    it("should handle missing movie ID", async () => {
      ...
      const promise = movieController.updateMovie(
        mockRequest,
        mockResponse as ServerResponse,
      );
      await promise;
  ...
  describe("deleteMovie", () => {
    ...
    it("should handle missing movie ID", async () => {
      mockRequest.url = undefined;
      const promise = movieController.deleteMovie(
        mockRequest,
        mockResponse as ServerResponse,
      );
      await promise;
